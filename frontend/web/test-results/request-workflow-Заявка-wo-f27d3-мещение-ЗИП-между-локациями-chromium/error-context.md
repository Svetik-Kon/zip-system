...
- Name: request-workflow.spec.js >> Заявка, workflow, комментарии и уведомления >> складовщик проводит перемещение ЗИП между локациями
- Location: tests\e2e\request-workflow.spec.js:46:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/movements
Call log:
  - navigating to "http://localhost:5174/movements", waiting until "load"
