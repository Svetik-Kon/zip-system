...
- Name: request-workflow.spec.js >> Заявка, workflow, комментарии и уведомления >> клиент создает заявку, менеджер переводит ее на согласование, автор получает уведомление о статусе
- Location: tests\e2e\request-workflow.spec.js:11:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/requests/bee01e15-6f0d-4f90-a8ee-15f994864518
Call log:
  - navigating to "http://localhost:5174/requests/bee01e15-6f0d-4f90-a8ee-15f994864518", waiting until "load"
