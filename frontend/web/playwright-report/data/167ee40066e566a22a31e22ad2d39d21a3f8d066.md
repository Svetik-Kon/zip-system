...
- Name: request-workflow.spec.js >> Заявка, workflow, комментарии и уведомления >> внутренний комментарий виден сотруднику с бейджем и скрыт от заказчика
- Location: tests\e2e\request-workflow.spec.js:29:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5174/requests/0c39c425-b353-4c6e-ab54-a9b3f13ca1a4
Call log:
  - navigating to "http://localhost:5174/requests/0c39c425-b353-4c6e-ab54-a9b3f13ca1a4", waiting until "load"
